...
const MultipleChoice = (props) => {
    ...
    const saveChangesHandler = (event) => {
        ...
        if (question.answers.length === question.right_answer.length) {
            alert('sie konnen nicht alle als richtig auswahlen');
            return;
        }
                                    ...
                                    <div key={a.id} id={a.id} className={classes.choiceOne_answers_item}>
                                        <div className="input-group-prepend">
                                            <div className="input-group-text">
                                                <input type="checkbox" name={`answer ${a.id}`} checked={question.right_answer.some(ra => ra.id === a.id) ? true : false} onChange={onRgihtAnswerChangeHandler.bind(null, a.id)} />
                                            </div>
                                        </div>
